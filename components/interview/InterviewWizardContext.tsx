...
const InterviewWizardContext = createContext<InterviewWizardContextType | undefined>(undefined)
...
export function useInterviewWizard() {
  ...
  if (context === undefined) {
    throw new Error("useInterviewWizard must be used within an InterviewWizardProvider")
  }
  return context
}
