	...
	return (
		<div>
			<h2 className="text-xl font-semibold mb-4">
				예약된 면접 ({scheduledInterviews.length})
			</h2>
			...
			{scheduledInterviews.length === 0 ? (
				...
				<div className="space-y-4">
					{scheduledInterviews.map(interview => {
						const resume =
							interview.kind === 'individual'
								? getResumeById(interview.resumeId)
								: null
						const coverLetter =
							interview.kind === 'individual'
								? getCoverLetterById(interview.coverLetterId)
								: null
									...
									<div className="flex items-center justify-between">
										<div className="flex-1">
												...
												<div>
													...
													<div className="flex items-center space-x-4 text-sm text-gray-600">
														...
														<div className="flex items-center space-x-1">
															...
															<span>
																{interview.options?.answerDuration || 3}분 답변
															</span>
														</div>
													</div>
												</div>
											...
											<div className="flex items-center space-x-2 mb-3">
												...
												<Badge variant="outline">
													{interview.options?.voiceType || '한국어'}
												</Badge>
											</div>
												...
												coverLetter && (
													<div className="text-sm text-gray-600 space-y-1">
														...
														<div className="flex items-center space-x-2">
															<FileText className="h-4 w-4" />
															<span>
																자소서: {coverLetter.representativeTitle}
															</span>
														</div>
													</div>
												)}
