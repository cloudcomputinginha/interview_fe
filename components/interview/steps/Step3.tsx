		...
		<div className="space-y-6">
				...
				<div className="grid grid-cols-2 gap-3">
					{[
						...
						},
						{
							value: 'female40',
							label: '👩‍🦳 여성(40대)',
							sample: '안녕하세요! 편안하게 답변해주세요.',
						},
						{
							value: 'female50',
							label: '👵 여성(50대)',
							sample: '안녕하세요! 좋은 면접이 되길 바랍니다.',
						},
						{
							value: 'male20',
							label: '👨‍🦱 남성(20대)',
			...
			<div className="space-y-2">
				...
				<div className="grid grid-cols-2 gap-2 p-1 bg-gray-100 rounded-lg">
					<Button
						variant={
							form.interviewStyle === 'personality' ? 'default' : 'ghost'
						}
