...
export default function ConsentPage() {
	...
	const handleSingleChange = (key: string, checked: boolean) => {
		...
		const allChecked =
			newConsents.name &&
			newConsents.email &&
			newConsents.jobInterests &&
			newConsents.activityHistory
			...
			<main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
				<div className="w-full max-w-md">
					...
					<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
							...
							<div className="space-y-4">
								...
								<div className="flex items-center space-x-3">
									<Checkbox
										...
										onCheckedChange={checked =>
											handleSingleChange('name', checked as boolean)
										}
										className="data-[state=checked]:bg-[#8FD694] data-[state=checked]:border-[#8FD694]"
									/>
									<div className="grid gap-1.5">
										<label
											htmlFor="name-consent"
											className="text-sm font-medium leading-none"
										>
											이름 (필수)
										</label>
										<p className="text-xs text-gray-500">
											면접 진행 및 결과 분석에 사용됩니다.
										</p>
									</div>
								</div>
								...
								<div className="flex items-center space-x-3">
									<Checkbox
										...
										onCheckedChange={checked =>
											handleSingleChange('email', checked as boolean)
										}
										className="data-[state=checked]:bg-[#8FD694] data-[state=checked]:border-[#8FD694]"
									/>
									<div className="grid gap-1.5">
							...
							<div className="space-y-4">
								...
								<div className="flex items-center space-x-3">
									<Checkbox
										...
										onCheckedChange={checked =>
											handleSingleChange('jobInterests', checked as boolean)
										}
										className="data-[state=checked]:bg-[#8FD694] data-[state=checked]:border-[#8FD694]"
									/>
									<div className="grid gap-1.5">
								...
								<div className="flex items-center space-x-3">
									<Checkbox
										...
										onCheckedChange={checked =>
											handleSingleChange('activityHistory', checked as boolean)
										}
										className="data-[state=checked]:bg-[#8FD694] data-[state=checked]:border-[#8FD694]"
									/>
									<div className="grid gap-1.5">
										<label
											htmlFor="activity-consent"
											className="text-sm font-medium leading-none"
										>
											활동 이력 (선택)
										</label>
										<p className="text-xs text-gray-500">
											서비스 개선 및 맞춤형 추천에 활용됩니다.
										</p>
									</div>
								</div>
							</div>
						...
						<Button
							className="w-full mt-8 bg-[#8FD694] hover:bg-[#7ac47f] text-white"
