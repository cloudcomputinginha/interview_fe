        ...
        <div className="container mx-auto max-w-5xl">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8">자기소개서 업로드부터, AI 피드백까지 한 번에</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              {
                title: "AI 면접관",
                description: "실제 면접과 유사한 질문과 대화를 통해 실전 감각을 키웁니다.",
              },
              {
                title: "실시간 피드백",
                description: "답변 직후 즉각적인 피드백으로 개선점을 바로 확인할 수 있습니다.",
              },
              {
                title: "자기소개서 분석",
                description: "업로드한 자기소개서를 기반으로 맞춤형 질문을 생성합니다.",
              },
            ].map((feature, index) => (
          ...
          <div className="bg-[#8FD694] bg-opacity-10 p-8 rounded-2xl">
            <div className="flex flex-col items-center text-center">
              <p className="text-xl italic mb-6">
                "InterviewPro AI 덕분에 자신감을 얻고 실제 면접에서도 좋은 결과를 얻을 수 있었습니다. 특히 피드백이
                구체적이어서 많은 도움이 되었어요."
              </p>
