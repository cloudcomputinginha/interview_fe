...
export default function GroupInterviewReportPage() {
	...
	const currentReport =
		participantReports[selectedParticipant as keyof typeof participantReports]
			...
			<div className="max-w-4xl mx-auto p-6">
					...
					<div className="flex justify-between items-center">
						<div>
							...
							<p className="text-gray-600 mt-1">
								2023년 5월 16일 진행된 다대다 모의 면접 결과입니다.
							</p>
						</div>
				...
				<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 text-center">
					...
					<p className="mt-4 text-gray-700 max-w-2xl mx-auto">
						{currentReport.name}님은 전반적으로 우수한 면접 수행을
						보여주셨습니다. 특히 자기소개서와 일관된 답변과 구체적인 경험 사례가
						돋보였습니다. 일부 개선이 필요한 부분이 있으나, 충분히 경쟁력 있는
						면접 역량을 갖추고 있습니다.
					</p>
				</div>
				...
				<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
					...
					<p className="text-gray-600 mb-4">
						{currentReport.name}님의 각 질문에 대한 상세 피드백과 점수를
						확인하세요.
					</p>
					<div className="space-y-4">
				...
				<div className="flex justify-between">
					<Button
						variant="outline"
						onClick={() => (window.location.href = '/workspace/interviews')}
					>
						내 면접으로 돌아가기
					</Button>
					<Button
						...
						onClick={() =>
							(window.location.href = '/workspace/interview/start')
						}
					>
						새 면접 시작하기
					</Button>
