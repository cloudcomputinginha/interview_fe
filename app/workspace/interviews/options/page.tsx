	...
	return (
		<div className="min-h-screen bg-gray-50">
			<div className="max-w-3xl mx-auto p-6">
				...
				<div className="mb-8">
					<Link
						href="/workspace/interviews/start"
				...
				<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 space-y-8">
					...
					<div className="p-4 bg-gray-50 rounded-md">
						<div className="flex items-center">
							...
							<p className="text-sm">
								<span className="font-medium">최대 15개 질문, 자동 설정됨</span>{' '}
								- 자기소개서 내용을 기반으로 최적의 질문 수가 자동으로
								설정됩니다.
							</p>
						</div>
					</div>
				...
				<div className="flex justify-between">
					...
					<Button
						...
						onClick={() =>
							(window.location.href = '/workspace/interviews/session')
						}
					>
