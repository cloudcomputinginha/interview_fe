...
import type {
	Resume,
	CoverLetter,
} from '@/components/interview/steps/Step5Individual'
			...
			<div className="min-h-screen bg-gray-50">
				<div className="max-w-4xl mx-auto p-6">
					...
					<CreateInterviewProgress
						step={wiz.step}
						interviewType={wiz.form.interviewType}
					/>
					...
					<Card className="mb-6">
						...
						<CardContent>
							{wiz.step === 1 && (
								<Step1 form={wiz.form} setForm={wiz.setForm} />
							)}
							{wiz.step === 2 && <Step2 {...stepProps} />}
							{wiz.step === 3 && (
								<Step3 form={wiz.form} setForm={wiz.setForm} />
							)}
							{wiz.step === 4 && wiz.form.interviewType === 'individual' && (
								<Step4Individual form={wiz.form} setForm={wiz.setForm} />
							)}
							{wiz.step === 4 && wiz.form.interviewType === 'group' && (
								<Step4Group {...stepProps} />
							)}
							{wiz.step === 5 && wiz.form.interviewType === 'group' && (
								<Step5Group {...stepProps} />
							)}
					...
					<div className="flex justify-between">
						...
						<Button
							...
							onClick={() =>
								wiz.next(memberId ? String(memberId) : undefined, router)
							}
