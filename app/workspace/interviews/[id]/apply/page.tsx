		...
		return (
			<div className="min-h-screen flex items-center justify-center">
				<div className="text-center">
					...
					<Button
						onClick={() => router.push('/workspace/interview/group/community')}
					>
						커뮤니티로 돌아가기
					</Button>
				</div>
				...
				<Card>
					...
					<CardContent className="space-y-6">
								...
								<Card className="mt-2">
									<CardContent className="p-4 space-y-4">
										...
										<div className="flex space-x-2">
											...
											<Button
												variant="outline"
												onClick={() => setShowNewResume(false)}
												className="flex-1"
											>
												취소
											</Button>
									...
									<CardContent className="p-4 space-y-4">
										...
										<div className="flex space-x-2">
											<Button
												...
												disabled={
													!newCoverLetter.representativeTitle ||
						...
						<Button
							onClick={handleApply}
							disabled={
								!applicantEmail || !selectedResumeId || !selectedCoverLetterId
							}
