...
export default function ReportPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { data: result, isError, error } = useQuery({
        ...
        queryFn: () => aiFetch.get(`/interview/session/${interviewId}/${memberInterviewId}`),
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <div className="text-lg font-semibold text-gray-800 mb-1">수고하셨습니다</div>
                </div>
                {/* 최종 평가 */}
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8 text-center">
                    ...
                    <p className="text-gray-700 text-base leading-relaxed max-w-2xl mx-auto">{result?.final_report}</p>
                </div>
