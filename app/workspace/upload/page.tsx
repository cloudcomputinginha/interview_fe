        ...
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-3xl mx-auto p-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">자기소개서를 업로드하면 AI가 분석하여 맞춤형 면접 질문을 생성합니다.</p>
            </div>

            {/* Upload Area */}
            <div
              className={`border-2 border-dashed rounded-xl p-8 text-center mb-6 transition-colors ${isDragging ? "border-[#8FD694] bg-[#8FD694] bg-opacity-5" : "border-gray-300"
                }`}
            ...
            >
              ...
              <h3 className="text-lg font-medium mb-2">파일을 드래그하여 업로드하세요</h3>
              <p className="text-gray-500 mb-4">또는</p>
              <Button variant="outline" className="border-[#8FD694] text-[#8FD694] hover:bg-[#8FD694] hover:text-white">
                파일 찾기
              </Button>
              <p className="text-sm text-gray-500 mt-4">지원 파일 형식: PDF, DOCX, TXT (최대 5MB)</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
              ...
              <div className="mb-4">
                ...
                <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                  ...
                  <div className={`${text.length > 2000 ? "text-red-500" : ""}`}>{text.length} / 2000자</div>
                </div>
              </div>
