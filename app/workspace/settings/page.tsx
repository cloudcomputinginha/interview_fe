  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        {/* Header */}
        <div className="mb-8">
          <Link href="/workspace" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-6">
            <ArrowLeft className="h-4 w-4 mr-1" /> 워크스페이스로 돌아가기
          </Link>
          <h1 className="text-2xl font-bold">설정</h1>
          <p className="text-gray-600 mt-2">앱 설정 및 면접 기본 옵션을 관리합니다.</p>
        </div>
            ...
            <div className="grid gap-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 pl-7">앱의 테마를 변경합니다.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 pl-7">앱의 표시 언어를 변경합니다.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 pl-7">면접 알림 및 시스템 알림을 받습니다.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 pl-7">앱 사용 중 소리 효과를 활성화합니다.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 pl-7">작성 중인 내용을 자동으로 저장합니다.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>앱 버전 및 기기 정보를 확인합니다.</CardDescription>
                </CardHeader>
          ...
          <TabsContent value="interview">
            <Card>
              <CardHeader>
                ...
                <CardDescription>면접 진행 시 기본적으로 적용될 설정입니다.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* AI Voice */}
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    인성 면접은 인성, 가치관, 경험에 관한 질문 위주로 진행됩니다. 기술 면접은 직무 관련 전문 지식과 문제
                    해결 능력을 평가합니다.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">각 질문당 답변 시간을 설정합니다. 기본값은 2분입니다.</p>
                </div>
          ...
          <TabsContent value="privacy">
            <Card>
              <CardHeader>
                ...
                <CardDescription>개인정보 보호 및 보안 설정을 관리합니다.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Privacy Mode */}
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500 pl-7">서비스 개선을 위해 익명화된 사용 데이터를 공유합니다.</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500 pl-7">비밀번호 및 계정 보안 설정을 변경합니다.</p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <p className="text-sm text-gray-500">
                    데이터 내보내기를 통해 모든 면접 기록과 자기소개서를 다운로드할 수 있습니다. 데이터 삭제는 모든 개인
                    정보를 영구적으로 제거합니다.
                  </p>
                </div>
              </CardContent>
        ...
        <div className="mt-8 flex justify-end">
          <Button className="bg-[#8FD694] hover:bg-[#7ac47f] text-white">설정 저장</Button>
        </div>
      </div>
    </div>
  )
