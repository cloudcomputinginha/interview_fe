...
import { Camera, Mail, Phone, Edit, User, Shield, Lock, Bell } from "lucide-react"
  ...
  const profileCards = [
    {
      ...
      title: '기본 정보',
      icon: User,
      content: <ProfileBasicCard userData={userData} formData={formData} isEditing={isEditing} handleInputChange={handleInputChange} />,
    },
    {
      id: 2,
      title: '알림 설정',
      icon: Bell,
      content: <ProfileNotificationCard userData={userData} formData={formData} isEditing={isEditing} handleNotificationChange={handleNotificationChange} />,
    },
    {
      id: 3,
      title: '개인정보 설정',
      icon: Shield,
      content: <ProfilePrivacyCard userData={userData} formData={formData} isEditing={isEditing} handlePrivacyChange={handlePrivacyChange} />,
    },
    {
      id: 4,
      title: '계정 관리',
      ...
      <CommunityLayout activeItem='profile'>
        <div className='p-6 max-w-6xl mx-auto'>
          <div className='flex justify-between items-center mb-8'>
            ...
            {!isEditing ? (
              <Button className='bg-[#8FD694] hover:bg-[#7ac47f] text-white' onClick={() => setIsEditing(true)}>
